...
{\*\expandedcolortbl;;}
\margl1440\margr1440\vieww25100\viewh15140\viewkind0
...
function seqSmallBarrage() \{\
	...
	\
	// (cos(x*5\uc0\u960 +0.5\u960 )+1)/2 is a custom wave bounded by 0 and 1 used to set varying launch heights\
	function launchShell(x, useSpecial) \{\
		const isRandom = shellNameSelector() === 'Random';\
		let shellType = isRandom\
			? useSpecial ? randomSpecialShell : randomMainShell\
